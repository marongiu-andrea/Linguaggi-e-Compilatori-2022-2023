...
@.str = private unnamed_addr constant [9 x i8] c"a[1]: %i\00", align 1
...
15:                                               ; preds = %4
  ...
  %18 = call i32 (i8*, ...) @printf(i8* noundef getelementptr inbounds ([9 x i8], [9 x i8]* @.str, i64 0, i64 0), i32 noundef %17)
  br label %19
