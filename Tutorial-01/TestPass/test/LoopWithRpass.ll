...
!0 = distinct !DICompileUnit(language: DW_LANG_C99, file: !1, producer: "Ubuntu clang version 14.0.0-1ubuntu1", isOptimized: true, runtimeVersion: 0, emissionKind: NoDebug, splitDebugInlining: false, nameTableKind: None)
!1 = !DIFile(filename: "test/Loop.c", directory: "/mnt/g/.shortcut-targets-by-id/10TpmPIYrsOm6d3C4xCJRV335p2U7zMUY/TERZO ANNO CONDIVISO/linguaggi marongiu/progetti/DEFINITIVO/Linguaggi-e-Compilatori-2022-2023/Tutorial-01/TestPass")
